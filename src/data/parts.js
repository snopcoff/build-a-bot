...
const parts = {
    heads: [
        {
            id: 1,
            description: 'A robot head with an unusually large eye and teloscpic neck -- excelllent for exploring high spaces.',
            title: 'Large Cyclops',
    ...
    torsos: [
        {
            id: 1,
            description: 'A torso that can bend slightly at the waist and equiped with a heat gauge.',
